...
class globalNet(nn.Module):
    ...
    def forward(self, x, local_feature, task_idx=0):
        ...
        local_feature = getattr(self,
                                'in_local{}'.format(task_idx))(local_feature)
...
class GLN(nn.Module):
    ...
    def __init__(self, localNet, localNet_params, globalNet_params):
        ...
        globalNet_params = {k: v for k, v in globalNet_params.items()
                            if k in [arg for arg in globalNet.__init__.__code__.co_varnames]}
